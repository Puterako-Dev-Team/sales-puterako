        ...
        <tbody>
            @forelse($tipes as $tipe)
                <tr class="border-b hover:bg-gray-50 transition-colors">
                    <td class="px-4 py-3 font-medium">{{ $tipe->nama }}</td>
                    <td class="px-4 py-3 text-gray-600">{{ $tipe->created_at->format('d M Y, H:i') }}</td>
                    <td class="px-4 py-3 text-center">
                        <div class="flex gap-2 justify-center">
                            <button class="btn-edit bg-blue-500 text-white px-3 py-1 rounded text-xs hover:bg-blue-600 transition-colors"
                                    data-id="{{ $tipe->id }}" title="Edit">
                ...
                <tr>
                    <td colspan="3" class="py-8 text-center">
                        <div class="flex flex-col items-center justify-center text-gray-500 gap-2">
                            ...
                            <span>Tidak ada barang yang ditemukan</span>
                        </div>
                    </td>
                </tr>
            @endforelse
